...
from models.KGRL import KGRL_ACModel
...
parser.add_argument("--full_dist", action="store_true", default=False,
                    help="use full knowledge distributions instead of only the most likely value")
parser.add_argument("--run_name", type=str, default="test",
                    help="run name to use for wandb logging")
...
if __name__ == "__main__":
    ...
    # Load model
    if args.agent == "KGRL":
        acmodel = KGRL_ACModel(obs_space, 
                                envs[0].action_space, 
                                args.module_dirs, 
                                args.module_types,
                                args.n_neighbours,
    ...
    elif args.agent == "KoGuN":
        acmodel = KoGuN_ACModel(obs_space, 
                                envs[0].action_space, 
                                args.module_dirs, 
                                args.module_types,
                                args.n_neighbours,
    ...
    elif args.agent == "AMRL":
        acmodel = AMRL_ACModel(obs_space, 
                                envs[0].action_space, 
                                args.module_dirs,
                                args.module_types,
                                args.n_neighbours, 
    ...
    elif args.agent == "KIAN":
        acmodel = KIAN_ACModel(obs_space, 
                                envs[0].action_space, 
                                args.module_dirs,
                                args.module_types,
                                args.n_neighbours, 
        ...
        raise ValueError("Incorrect agent name: {}".format(args.agent))
    ...
    if continuous_actions:
        assert args.algo == "a2c" "Continuous actions can only be used with A2C or PPO"
    ...
    if args.wandb_log:
        wandb.init(
            ...
            "algorithm": args.algo,
            "frames": args.frames,
            "modules": args.module_dirs,
            "module types": args.module_types,
            }
        )
